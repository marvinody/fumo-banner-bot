...
const aprilFools = require("../utilities/addAprilFoolsToImage");
...
module.exports = async (client) => {
  const cronjobTime = await getSetting(
    client.db,
    SETTINGS.CRON_TIME,
    config.defaultCronTime,
  );

  const job = new CronJob(cronjobTime, changeServerBanner.bind(null, client));
  return job;
};
